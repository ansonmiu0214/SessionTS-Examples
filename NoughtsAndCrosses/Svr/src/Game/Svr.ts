...
class Session {
    ...
    private initialState: Implementation.S13;
    ...
    constructor(wss: WebSocket.Server,
        ...
        this.activeRoles = new Set([Roles.Peers.P2, Roles.Peers.P1]);
    ...
    restart() {
        new Svr(this.wss, this.initialState, this.cancellation);
    }
