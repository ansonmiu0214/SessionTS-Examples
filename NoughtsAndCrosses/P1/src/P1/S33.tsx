...
export default abstract class S33<ComponentState = {}> extends React.Component<Props, ComponentState>
{
    ...
    abstract Win(payload1: Point, ): MaybePromise<void>; abstract Draw(payload1: Point, ): MaybePromise<void>; abstract Update(payload1: Point, ): MaybePromise<void>;
}